  ...
  const [vehicles, setVehicles] = useState<PartnerVehicle[]>([
    {
      ...
      pricePerHour: 7500,
      pricePerDay: 45000,
      specifications: ['Type: Topsoil', 'pH Level: 6.0-7.0', 'Organic Matter: >3%', 'Nutrients: NPK enriched'],
      images: ['https://i.pinimg.com/736x/0a/e6/b9/0ae6b95831b6064072cf7fe18b440985.jpg'],
      available: true,
      location: partner.address,
      insuranceDetails: {
        provider: 'Material Quality Assurance',
        policyNumber: 'MQA123456789',
        expiryDate: '2025-06-30'
      },
      maintenanceRecords: {
        lastService: '2024-01-15',
        nextService: '2024-04-15',
        certifications: ['Quality Certified', 'Organic Certified']
      },
      status: 'active'
    }
  ]);
  ...
  const [feedbacks] = useState<CustomerFeedback[]>([
    {
      ...
      vehicleName: 'Premium Garden Soil',
      rating: 5,
      comment: 'Excellent quality soil! Perfect for our landscaping project. The soil was rich and fertile, exactly what we needed.',
      date: '2024-01-10',
      verified: true
    },
    {
      ...
      vehicleName: 'Premium Garden Soil',
      rating: 4,
      comment: 'Good quality soil and reliable delivery service. The supplier was professional and the pricing was fair.',
      date: '2024-01-08',
      verified: true
    },
    {
      ...
      vehicleName: 'Premium Garden Soil',
      rating: 5,
      comment: 'Outstanding quality! Very reliable supplier and the soil was delivered on time. Will definitely order again.',
      date: '2024-01-05',
      verified: false
    }
  ]);
                  ...
                  {vehicles.map((vehicle) => (
                    <div key={vehicle.id} className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                      <div className="relative">
                        <img
                          src={vehicle.images[0] || 'https://i.pinimg.com/736x/0a/e6/b9/0ae6b95831b6064072cf7fe18b440985.jpg'}
                          alt={vehicle.name}
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-4 mb-4">
                          <div className="grid grid-cols-2 gap-4">
                            <div className="text-center">
                              ...
                              <div className="text-xs text-gray-600">per cubic meter</div>
                            </div>
                            <div className="text-center">
                              <div className="text-lg font-bold text-blue-600">
                                Rs. {vehicle.pricePerDay.toLocaleString()}
                              </div>
                              <div className="text-xs text-gray-600">minimum order</div>
                            </div>
                          </div>
                        </div>
